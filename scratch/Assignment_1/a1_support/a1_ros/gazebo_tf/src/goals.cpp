...
public:
        ...
        nh_(nh),marker_counter_(0),seq_(0)
    {
        ...
        pipes = new Pipes(5,"/goal_buffer_seg","/goal_buffer_wsem","/goal_buffer_rsem");
    ...
    void run(void){
        ...
        while (ros::ok()){
          ...
          Goal goal;
          bool OK = pipes->readCommand(goal);
          if(OK){
              ROS_DEBUG_STREAM( "seq x/y " <<  goal.seq << " "
              ...
              addMarker(goal.point.x, goal.point.y, goal.seq);
