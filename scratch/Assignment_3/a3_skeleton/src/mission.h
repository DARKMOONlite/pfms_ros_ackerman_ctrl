...
public:
    ...
    */
  Mission(std::vector<ControllerInterface*> controllers,ros::NodeHandle nh);
   ...
   */
   void setGoals(std::vector<std::pair<pfms::geometry_msgs::Point,pfms::geometry_msgs::Point> > cones);
  // /**
...
void getGoal(const geometry_msgs::PoseArrayConstPtr &msg);
